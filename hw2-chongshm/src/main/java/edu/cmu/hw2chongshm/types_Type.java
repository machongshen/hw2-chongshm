...
public class types_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.hw2chongshm.types");
  ...
  public String getGene_Sign(int addr) {
      ...
      jcas.throwFeatMissing("Gene_Sign", "edu.cmu.hw2chongshm.types");
  ...
  public String getGene_Mark(int addr) {
      ...
      jcas.throwFeatMissing("Gene_Mark", "edu.cmu.hw2chongshm.types");
  ...
  public int getStart(int addr) {
      ...
      jcas.throwFeatMissing("start", "edu.cmu.hw2chongshm.types");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "edu.cmu.hw2chongshm.types");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "edu.cmu.hw2chongshm.types");
  ...
  public String getCasProcessorId(int addr) {
      ...
      jcas.throwFeatMissing("casProcessorId", "edu.cmu.hw2chongshm.types");
